...
(function () {
  ...
  var PATHS = {
    ...
    client_preview_approved: '<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="m9 11 3 3L22 4"/>',
  ...
  window.MH.notifIcons = {
    ...
    get: function (type) {
      ...
      var cls = '';
      if (type === 'order_new' || type === 'task_assigned' || type === 'client_feedback_received' || type === 'client_preview_approved') cls = 'is-accent';
